...
//	public:
//		factory_wrapper(void* data = nullptr) {
//#ifdef EEGO_SDK_BIND_STATIC
//			m_factory = std::make_unique<eemagine::sdk::factory>(data);
//#else
//			m_factory = std::make_unique<eemagine::sdk::factory>("eego-SDK.dll", data);
//#endif // EEGO_SDK_BIND_STATIC
//		}
//	private:
//		std::unique_ptr<eemagine::sdk::factory> m_factory;
//	};
//
//} // end namespace
